...
Prerequisites: ISPF ≥ 0.9.32, [DRIVER_INTEROP_LAB.md](DRIVER_INTEROP_LAB.md) green locally, operator account with device admin role.
...
Expose selected ISPF variables to external UA clients (UA Expert, Prosys). See [OPCUA_SERVER_INTEROP.md](OPCUA_SERVER_INTEROP.md).
...
- [DRIVER_INTEROP_LAB.md](DRIVER_INTEROP_LAB.md) — CI loopback matrix
- [DRIVERS.md](DRIVERS.md) — driver configs
- [ROADMAP_PHASE25.md](ROADMAP_PHASE25.md) — BL-140, BL-141, BL-143
