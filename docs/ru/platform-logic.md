...
|--------|-----|----------|--------|
| `showWhenJson` | поле функциональной формы | Правило CEL для объекта формы или правило на информационной панели `context.params.*` | время выполнения сохранён; Миграция пользовательского интерфейса — этап 3 |
