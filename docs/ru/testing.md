> **Язык:** полный русский перевод. Канонический английский: [en/testing.md](../en/testing.md).
...
Сценарии HTTP и внутреннего автоматического нагрузочного тестирования, базовые метрики и зонд информационной панели — **[LOAD_TESTING.md](load-testing.md)**.
