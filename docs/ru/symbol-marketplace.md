> **Язык:** полный русский перевод. Канонический английский: [en/symbol-marketplace.md](../en/symbol-marketplace.md).

# Торговая площадка символов (BL-185)
...
| Установить через API торговой площадки платформы | Редактор пользовательских символов SaaS |
...
Пакеты символов поставляются по тому же контракту торговой площадки, что и пакеты приложений ([MARKETPLACE.md](marketplace.md)):
...
| Панель «Торговая площадка» | Просматривайте списки удаленных символов; установить бесплатно/активировать платно |
...
- Обзор листинга на торговой площадке
...
| удостоверение личности | Результат |
|----|-------------|
| БЛ-146 | Библиотека символов P&ID v2 (справочный пакет платформы) |
| БЛ-183 | Marketplace GA (совместный процесс установки/активации) |
| БЛ-185 | Документы торговой площадки символов + договор о листинге (данный документ) |

---

## Сопутствующие документы

- [SCADA.md](scada.md) — имитация архитектуры
