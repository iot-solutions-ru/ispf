...
**Основной принцип ISPF:** бизнес-логика решений живёт **на платформе** — в моделях, функциях, событиях, функциях и дереве объектов рабочих процессов. Ядро предлагает только общие-движки; Решение — декларативная конфигурация. См. [ARCHITECTURE.md](architecture.md).
