...
**Суть:** один манифест JSON/ZIP описывает всё решение. **North star** для производства.
...
| [APPLICATION_PRINCIPLES.md](application-principles.md) | принципы применения | Свод P1–P10, North star, антипаттерны |
