...
При возникновении fire events, если задан вебхук и/или адрес электронной почты — дополнительно возникает `NotificationDispatchService` (ошибки регистрируются, оповещение не блокируется).
