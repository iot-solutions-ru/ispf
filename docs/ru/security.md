> **Язык:** полный русский перевод. Канонический английский: [en/security.md](../en/security.md).
...
**разработчик** может: всё для конфигурации решений (объекты, приложения, инструменты платформы SQL, `executeQuery`, **AI Studio**), но **нет** системные настройки, безопасность, федерация, арендаторы, лицензия/кластер.
