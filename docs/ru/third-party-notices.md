...
| ЯРГ | 2.2.22 | Апач-2.0 | DOCX/HTML шаблоны (legacy; spreadsheet по умолчанию POI) |
| Apache POI | через BOM / прямо | Апач-2.0 | Spreadsheet Band1 Template Filler + табличный экспорт |
| документ4j | 8.3.11 | Апач-2.0 | Путь YARG XLSX/DOCX (pin; major ignore, ADR-0053) |
