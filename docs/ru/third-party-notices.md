> **Язык:** полный русский перевод. Канонический английский: [en/third-party-notices.md](../en/third-party-notices.md).
...
Код платформы в репозитории лицензируется под **GNU AGPL-3.0** ([ADR-0016](decisions/0016-agpl-dual-licensing.md)). Сторонние библиотеки сохраняют свои ресурсы.
...
3. Удалить/заменить GPL-компоненты из Apache/основного профиля или явно маркировать поставку как авторское лево/содержащие GPL.
