> **Язык:** полный русский перевод. Канонический английский: [en/semantic-demo.md](../en/semantic-demo.md).

# Семантическое демонстрационное прохождение (S23-04/BL-105)

Цель: первая семантическая панель мониторинга из запроса Haystack за **≤5 минут** (ускорение KPI S23-04).
...
Построитель информационной панели → Диалоговое окно **Привязка Haystack** → фильтр `point and temp` → привязка виджетов значений/диаграмм к совпадающим точкам (BL-103).
