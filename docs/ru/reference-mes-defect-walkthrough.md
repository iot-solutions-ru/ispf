> **Язык:** русская версия (вычитка). Канонический английский: [en/reference-mes-defect-walkthrough.md](../en/reference-mes-defect-walkthrough.md).

# MES: walkthrough распределения брака
