...
| Nightly GHA soft floor | 300 | ≥15 (static + WS) | `nightly.yml`: `MIMIC_STRESS_ELEMENTS=300`, `MIMIC_MIN_FPS=15`, `MIMIC_MIN_FPS_WS=15` — shared runners; не заявление ≥55 на GHA |
