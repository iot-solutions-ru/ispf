...
> **Статус: Partial (BL-183).** Локальный / настроенный remote catalog + free install — реальны. Partner catalogs, symbol listing API и полный marketplace GA — **не** завершены — см. [competitive-scorecard](competitive-scorecard.md), измерение 12, и чеклист ниже. Не читайте каждый статус «Реализовано» как готовность внешнего/partner GA.
