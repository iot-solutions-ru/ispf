...
|----------------|----------------------|----------|
| *(по умолчанию / не указан)* | Deploy application bundle | [applications.md](applications.md) |
...
- [analytics-formulas-and-packs.md](analytics-formulas-and-packs.md) — Tier C packs в маркетплейсе
