> **Язык:** полный русский перевод. Канонический английский: [en/scada.md](../en/scada.md).
...
Координаты элементов — **пиксели на артборде**, без ячеек сетки информационной панели.
...
| Категория | удостоверение личности | Описание |
|-----------|-----|----------|
...
- Привязки имитируют использование тех же переменных, что и виджеты диаграммы/значений/функций.
