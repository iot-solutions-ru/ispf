> **Язык:** русская версия (вычитка). Канонический английский: [en/widgets.md](../en/widgets.md).
...
| внешний | Отчёты, события, навигация, другие дашборды | отчет, рабочая очередь, dashboard-link |
...
**Назначение:** компактный текстовый/цветной статус (драйвер, фаза).
...
**Назначение:** интерактивная SVG-иконка (лаборатория, mimic).
