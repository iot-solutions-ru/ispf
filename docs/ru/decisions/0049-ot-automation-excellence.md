...
**Прогресс волн (2026-07-19):** Wave 1–2 landed; Wave 3 **частично** — webhook + cron `every:1m` + запись DLQ/`errorWorkflowPath` + REST list/resolve dead letters; async retry scheduler ещё не сделан. Wave 4–5 не начаты. Канон: [en/0049](../../en/decisions/0049-ot-automation-excellence.md).
