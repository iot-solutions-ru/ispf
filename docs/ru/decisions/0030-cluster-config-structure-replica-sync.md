> **Язык:** русская версия (вычитка). Канонический английский: [en/decisions/0030-cluster-config-structure-replica-sync.md](../../en/decisions/0030-cluster-config-structure-replica-sync.md).
