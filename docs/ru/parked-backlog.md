...
| P-PENTEST | Сторонний pen-test (G-01) | **Отложено** (prep углублён) | Контракт + отчёт + retest | [pen-test-scope.md](pen-test-scope.md), [pen-test-prep.md](pen-test-prep.md), кейсы EN [pen-test-cases.md](../en/pen-test-cases.md), `tools/security/pen-test-preflight.sh` |
