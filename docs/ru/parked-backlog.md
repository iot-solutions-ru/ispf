...
| P-OT | Фаза 25 OT Trust (BL-140…) | **В работе** (Pilot #1 soak days 1–3 + C5; Pilot #2 MQTT day 1 + C5) | 7-day soak + OT sign-off для field Done | **Pilot #1** Modbus: [day 3](../evidence/ot-trust/2026-09-08-bl140-pilot1-day3.md). **Pilot #2** MQTT: [day 1](../evidence/ot-trust/2026-09-08-bl140-pilot2-mqtt-day1.md). Jump key auth восстановлен. Не OT 10/10. |
