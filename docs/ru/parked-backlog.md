...
| P-OT | Фаза 25 OT Trust (BL-140…) | **В работе** (lab-каталог закрыт; поле открыто) | Именованная площадка + soak journals для field Done | Lab-каталог **162/162**, stubs **0** (Waves 1–11 / #144). ADR-0057 DNP3 poll-only. Docker-фикстуры: **mqtt/modbus-tcp/modbus-udp/modbus-rtu/opcua/snmp/http/bacnet/iec104/ethernet-ip/dlms/dnp3/s7/gps-tracker** (14/20) — [GPS tracker depth](../evidence/ot-trust/2026-09-06-bl141-gps-tracker-fixture.md). `opc-da`/`opc-bridge` = `SHELL_BETA`. Lab ≠ OT 10/10. |
