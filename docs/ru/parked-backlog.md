...
| P-OT | Фаза 25 OT Trust (BL-140…) | **В работе** (Pilot #1 day 1 + C5 на lab OT VLAN; soak открыт) | 7-day soak + OT sign-off для field Done | Lab-каталог **162/162**, stubs **0** (#144). Docker **14/20**. **BL-140 Pilot #1** site=`lab-ot-vlan-192.168.100`: [day 1](../evidence/ot-trust/2026-09-06-bl140-pilot1-lab-day1.md) · [C5](../evidence/ot-trust/2026-09-06-bl140-pilot1-c5-disconnect.md) · [checklist](../evidence/ot-trust/pilot1-modbus-plant.checklist.md) · [journal](../evidence/ot-trust/pilot1-modbus-plant.journal.md). Daily timer 06:00 MSK. Не OT 10/10. |
