...
| P-OT | Фаза 25 OT Trust (BL-140…) | **В работе** (lab-каталог закрыт; kickoff-пакет пилота готов; **C1 площадка открыта**) | Именованная площадка + soak journals для field Done | Lab-каталог **162/162**, stubs **0** (#144). Docker-фикстуры **14/20**. **BL-140 Pilot #1** (Modbus): [kickoff](../evidence/ot-trust/2026-09-06-bl140-pilot1-kickoff.md) · [checklist](../evidence/ot-trust/pilot1-modbus-plant.checklist.md) · [journal](../evidence/ot-trust/pilot1-modbus-plant.journal.md). `opc-da`/`opc-bridge` = `SHELL_BETA`. Lab ≠ OT 10/10. |
