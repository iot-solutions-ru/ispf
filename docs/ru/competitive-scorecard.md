...
Матрица публичной готовности для Phases 25–33 (фазы 25–33). **Актуальный столбец:** **Проверено по коду** — доказательства из `main`, исходников и тестов (релиз **0.9.102**, июль 2026).
...
Из [roadmap.md](roadmap.md) (Фазы 25–33 / DoD). Статус на **0.9.102**:
