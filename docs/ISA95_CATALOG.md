...
**See also:** [OBJECT_MODEL.md](OBJECT_MODEL.md), [REFERENCE_MES_OEE_WALKTHROUGH.md](REFERENCE_MES_OEE_WALKTHROUGH.md), [mes-oee-reference](../examples/mes-oee-reference/).
...
- OEE: [REFERENCE_MES_OEE_WALKTHROUGH.md](REFERENCE_MES_OEE_WALKTHROUGH.md)
- Escalation: [REFERENCE_ESCALATION_TEMPLATES.md](REFERENCE_ESCALATION_TEMPLATES.md)
