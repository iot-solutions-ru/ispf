...
Related: [MARKETPLACE.md](MARKETPLACE.md), [SCADA_MIMIC.md](SCADA_MIMIC.md), [ROADMAP_PHASE25.md](ROADMAP_PHASE25.md) (BL-146, BL-185).
...
Symbol vendors join the [Partner program](PARTNER_PROGRAM.md) at **OEM** level:
