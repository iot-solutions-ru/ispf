...
| `ISPF_BOOTSTRAP_FIXTURES_ENABLED` | true | Demo/lab fixture models и demo-узлы (`mqtt-sensor-v1`, …). См. [ADR-0018](decisions/0018-fixture-models-and-cel-applicability.md) |
