# ADR-0014: Bundle = tree packaging
...
5. **Commercial** — optional секция `license` (см. [ADR-0010](0010-commercial-bundle-licensing.md)); Apache reference bundles без `license`.
...
- Отраслевой Java в `ispf-server` остаётся запрещён ([ADR-0008](0008-app-platform-boundary.md)).
