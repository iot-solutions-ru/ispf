# ADR-0008: Граница platform и solution (app/platform boundary)
...
- Reference apps (`examples/*`) и commercial bundle — вне обязательного ядра или с отдельной лицензией ([ADR-0010](0010-commercial-bundle-licensing.md)).
...
- [ADR-0009](0009-dogfooding-gate.md)
