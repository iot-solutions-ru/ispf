...
Критерий нового REQ-PF: *можно ли выразить потребность через существующий или обобщённый механизм дерева объектов?* Если да — расширяем механизм; если нет — gate 0002 (отдельное ADR или отказ).
