...
Historian телеметрии (`variable_samples`) уже использует TimescaleDB hypertable ([0009](0009-timescaledb-retention.md)). Event journal до этого жил в обычной таблице PG.
