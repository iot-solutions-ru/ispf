...
| File | Site | Result |
| ---- | ---- | ------ |
| [2026-09-05-ispf-vps-0.9.207-offline-8h.json](./2026-09-05-ispf-vps-0.9.207-offline-8h.json) | ispf.iot-solutions.ru @ **0.9.207** | Lab automated **8 h** CDP offline (`ui-pump-station`) — **PASS** (30 samples / 10 min, reconnect OK) |
| [2026-09-05-ispf-vps-0.9.207-journal-8h.md](./2026-09-05-ispf-vps-0.9.207-journal-8h.md) | lab automated | Journal for 8h stretch — closes **P-HMI-8H** (not on-site tablet) |
...
E2E_USERNAME=admin E2E_PASSWORD=admin \
E2E_OPERATOR_APP=ui-pump-station \
HMI_OFFLINE_SOAK_MINUTES=480 \
HMI_OFFLINE_SAMPLE_EVERY_SEC=600 \
HMI_OFFLINE_SOAK_EVIDENCE=../../docs/evidence/hmi-offline/YYYY-MM-DD-ispf-vps-offline-8h.json \
  npm run pwa:offline-field-soak
```

On-site tablet / airplane mode remains the field sign-off tier (**P-HMI-FIELD**) — see [hmi-offline-field-soak.md](../../en/hmi-offline-field-soak.md).
