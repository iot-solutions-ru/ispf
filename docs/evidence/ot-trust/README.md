...
| **Field trust** | Still open — [Pilot #1 kickoff pack](2026-09-06-bl140-pilot1-kickoff.md) ready; **C1 site name** still required for ready-for-field |
...
**Field track:** Pilot #1 (Modbus plant) kickoff pack published 2026-09-06 — checklist C1–C6 + empty soak journal. **Named site (C1) still open**; docker fixtures remain BL-141 lab depth only.
