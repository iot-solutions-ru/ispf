...
| **Field trust** | **In progress** — Pilot #1 on `lab-ot-vlan-192.168.100`; day 1 + [C5 disconnect](2026-09-06-bl140-pilot1-c5-disconnect.md) green; soak days 2–7 open. Not OT 10/10. |
...
**Field track:** Pilot #1 (Modbus) on **`lab-ot-vlan-192.168.100`**. Day 1 §1 + **C5 disconnect** green. Daily soak timer armed. Days 2–7 + sign-off remain. HMI mimic badge optional.
