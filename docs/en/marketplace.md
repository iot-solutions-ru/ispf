...
| `ui-pack` | `ISPF_UI_PACKS_DIR` → served at `/apps/<appId>/` (ADR-0054) | [0054-hosted-ui-packs](decisions/0054-hosted-ui-packs.md), [external-ide](external-ide.md) |
