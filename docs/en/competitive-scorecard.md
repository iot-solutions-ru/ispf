...
6. **HMI (7.5 → 9+):** live Object WS FPS path has dated demostand evidence ([`hmi-fps/2026-09-04-…ui-pump-station`](../evidence/hmi-fps/2026-09-04-ispf-vps-0.9.207-ui-pump-station.json) @ **0.9.207**, ~7 el @ 60 FPS / 471 WS) and first **unmocked 500-el** archive ([`hmi-fps/2026-09-04-…hmi-stress-500`](../evidence/hmi-fps/2026-09-04-ispf-vps-0.9.207-hmi-stress-500.json), median ~47 FPS, soft floor 20). Residual toward 9+: HMI 2h offline soak; keep HMI score frozen until next full audit.
