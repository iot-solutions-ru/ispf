...
5. **Historian (7.0 → 9+):** JVM scale gates **PASS** locally ([`historian-scale/2026-09-04-jvm-…`](../evidence/historian-scale/2026-09-04-jvm-analytics-scale-gate.md)). **Lab sign-off 2026-09-05** on `192.168.100.10`: 50k history-enabled + ≥1B CH + multi-tag p95≈49 ms ([evidence](../evidence/historian-scale/2026-09-05-lab-192.168.100.10-enterprise-l.md)). Frozen score stays **7.0** until next full competitive audit (then expect **≥9.5**). Demostand remains a small site — not the L catalog.
6. **HMI (7.5 → 9+):** live Object WS FPS path has dated demostand evidence ([`hmi-fps/2026-09-04-…ui-pump-station`](../evidence/hmi-fps/2026-09-04-ispf-vps-0.9.207-ui-pump-station.json) @ **0.9.207**, ~7 el @ 60 FPS / 471 WS) and first **unmocked 500-el** archive ([`hmi-fps/2026-09-04-…hmi-stress-500`](../evidence/hmi-fps/2026-09-04-ispf-vps-0.9.207-hmi-stress-500.json), median ~47 FPS, soft floor 20). Lab automated **2 h** + **8 h** offline soaks archived ([`hmi-offline/2026-09-04-…offline-2h`](../evidence/hmi-offline/2026-09-04-ispf-vps-0.9.207-offline-2h.json), [`…offline-8h`](../evidence/hmi-offline/2026-09-05-ispf-vps-0.9.207-offline-8h.json), CDP). Residual toward 9+: on-site tablet (**P-HMI-FIELD**); keep HMI score frozen until next full audit.
