...
5. New platform capabilities are tracked as **REQ-PF** (see [roadmap.md](../roadmap.md)).

## Consequences

- Reference apps (`examples/*`) and commercial bundles are outside mandatory core or carry a separate license ([0003](0003-commercial-bundle-licensing.md)).
- PR checklist: [plugins.md](../plugins.md).
- Application API is documented in [applications.md](../applications.md).
