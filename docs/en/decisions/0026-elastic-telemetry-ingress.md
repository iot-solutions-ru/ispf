...
- `TelemetryEventJournalFastPath` for `EVENT_JOURNAL_ONLY` — driver ingress → async journal ([0027-event-journal-ingress-fast-path](0027-event-journal-ingress-fast-path.md)).
