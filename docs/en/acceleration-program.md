...
Eight-week delivery program after closing the excellence wave S01–S18.  
Sprint source: [roadmap.md § S19–S23](roadmap.md).

| | |
| --- | --- |
| **Start** | 2026-07-05 |
| **Freeze until** | 2026-08-30 (8 weeks) |
| **Program owner** | Platform lead |
| **Cadence** | Weekly scorecard (Fri), sprint demo |
...
| -- | ----------- | -------- |
| S19-01 | Metrics baseline | [§ Baseline](#baseline-2026-07-05), `tools/acceleration/baseline-report.json` |
| S19-02 | Scorecard + cadence | [§ Scorecard](#weekly-scorecard) |
| S19-03 | Scope freeze | [§ Scope freeze](#scope-freeze-s20s23) |

Refresh baseline: `python tools/acceleration/collect-baseline.py` (GitHub Actions + local).

---

## Baseline (2026-07-05)

Frozen on `main`, July 2026. Acceleration improves from these points — no new scope mixed in.

### CI / QA

| KPI | Baseline | Source | Target (S20) |
| --- | -------- | -------- | ------------ |
...
| KPI | Baseline | Source | Target (S21) |
| --- | -------- | -------- | ------------ |
...
| KPI | Baseline | Source | Target (S22) |
| --- | -------- | -------- | ------------ |
...
| KPI | Baseline | Source | Target (S23) |
| --- | -------- | -------- | ------------ |
...
**When:** every Friday, 30 min.  
**Attendees:** program owner, DevOps, QA lead, frontend lead, platform lead.

**Agenda**

1. KPI review (table below) — green / yellow / red
2. Sprint demo (if end of two-week cycle)
3. Blockers and escalations
4. Scope change requests (only via [change control](#change-control))
5. Update “Week N” row in scorecard log
...
**Period:** 2026-07-05 → 2026-08-30.  
**Rule:** new epics/features **not added** without change control. P0/P1 bugfix and ops — always allowed.
...
1. Requester opens issue with label `acceleration-change`
...
4. Log decision in scorecard week notes + roadmap history
