...
| Multi-tenancy isolation | **Logical** SaaS A≠B (path+API+`tenant-admin`) **Exists**; OIDC `tenant_id` claim; **hard** mode schema provision/drop; **PostgreSQL RLS** on shared platform object tables when `ispf.tenant.db-row-isolation=true`; physical table routing still optional | [multi-tenant](multi-tenant.md) | **Exists** (logical + RLS on PG); hard table routing **Partial** |
...
| -- | ----- | ----- | --- | -------------- |
| G-01 | **Independent pen-test** | Hardening guidance + unit/API tests + **SOW prep** [pen-test-scope.md](pen-test-scope.md) + [pen-test-roe.md](pen-test-roe.md) + [pen-test-questionnaire.md](pen-test-questionnaire.md) + operator [pen-test-prep.md](pen-test-prep.md) + [pen-test-cases.md](pen-test-cases.md) + **vendor pack** [pen-test-vendor-pack.md](pen-test-vendor-pack.md) + lab preflight/inventory under `docs/evidence/security-pentest/` | No published third-party pen-test report; Phase 27 metric “pentest pass” **not met** | Hired assessment using vendor pack + scope/RoE/cases; archive redacted report + retest under `docs/evidence/security-pentest/` |
...
| Pen-test SOW prep (G-01) | [pen-test-vendor-pack.md](pen-test-vendor-pack.md) · [pen-test-scope.md](pen-test-scope.md) · [pen-test-roe.md](pen-test-roe.md) · [pen-test-questionnaire.md](pen-test-questionnaire.md) · [pen-test-prep.md](pen-test-prep.md) · [pen-test-cases.md](pen-test-cases.md) |
