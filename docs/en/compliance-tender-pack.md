...
| -- | ----- | ----- | --- | -------------- |
| G-01 | **Independent pen-test** | Hardening guidance + unit/API tests + **SOW prep** [pen-test-scope.md](pen-test-scope.md) + [pen-test-roe.md](pen-test-roe.md) + [pen-test-questionnaire.md](pen-test-questionnaire.md) + operator [pen-test-prep.md](pen-test-prep.md) + [pen-test-cases.md](pen-test-cases.md) | No published third-party pen-test report; Phase 27 metric “pentest pass” **not met** | Hired assessment using scope/RoE/prep/cases; archive redacted report under `docs/evidence/security-pentest/` |
