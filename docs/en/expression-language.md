...
Stable finding `codes` (for UI / AI): `SATISFIABLE`, `UNSATISFIABLE`, `TAUTOLOGY`, `NOT_TAUTOLOGY`, `EQUIVALENT`, … — see [ADR-0055](decisions/0055-cel-formal-verification-ai-gate.md). Historian helpers in boolean templates rewrite to correlated `self.__histN` placeholders before SMT. Demostand smoke (0.9.202): [`docs/evidence/cel-formal/2026-08-31-ispf-vps-0.9.202-verify-smoke.json`](../evidence/cel-formal/2026-08-31-ispf-vps-0.9.202-verify-smoke.json) (0.9.195 archive retained).
