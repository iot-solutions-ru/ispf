...
| P-OT | Phase 25 OT Trust field pilots (BL-140…) | **In progress** (Pilot #1 soak days 1–3 + C5; Pilot #2 MQTT day 1 + C5; days open) | 7-day soak journal + OT sign-off for field Done | Lab catalog **162/162**. **Pilot #1** Modbus: [day 3](../evidence/ot-trust/2026-09-08-bl140-pilot1-day3.md). **Pilot #2** MQTT: [day 1](../evidence/ot-trust/2026-09-08-bl140-pilot2-mqtt-day1.md). Jump key auth restored. Not OT 10/10. |
