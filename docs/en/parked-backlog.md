...
| P-OT | Phase 25 OT Trust field pilots (BL-140…) | **In progress** (lab catalog closed; field kickoff pack ready; **C1 site open**) | Named plant + soak journals for field Done | Lab catalog **162/162**, stubs **0** (#144). Docker fixtures **14/20**. **BL-140 Pilot #1** (Modbus): [kickoff](../evidence/ot-trust/2026-09-06-bl140-pilot1-kickoff.md) · [checklist](../evidence/ot-trust/pilot1-modbus-plant.checklist.md) · [journal](../evidence/ot-trust/pilot1-modbus-plant.journal.md). `opc-da`/`opc-bridge` = `SHELL_BETA`. Lab ≠ OT 10/10. |
