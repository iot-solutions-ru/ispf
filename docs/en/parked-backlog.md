...
| P-OT | Phase 25 OT Trust field pilots (BL-140…) | **In progress** (lab catalog closed; field open) | Named plant + soak journals for field Done | Lab catalog **162/162**, stubs **0** (Waves 1–11 / #144). ADR-0057 DNP3 poll-only. Docker fixtures: **mqtt/modbus-tcp/modbus-udp/opcua/snmp/http/bacnet/iec104/ethernet-ip/dlms** (10/20) — [Modbus UDP depth](../evidence/ot-trust/2026-09-06-bl141-modbus-udp-fixture.md). `opc-da`/`opc-bridge` remain `SHELL_BETA`. Lab ≠ OT 10/10. |
