...
| P-OT | Phase 25 OT Trust field pilots (BL-140…) | **In progress** (Pilot #1 day 1 on lab OT VLAN; soak open) | 7-day soak journal + OT sign-off for field Done | Lab catalog **162/162**, stubs **0** (#144). Docker fixtures **14/20**. **BL-140 Pilot #1** site=`lab-ot-vlan-192.168.100`: [day 1](../evidence/ot-trust/2026-09-06-bl140-pilot1-lab-day1.md) · [checklist](../evidence/ot-trust/pilot1-modbus-plant.checklist.md) · [journal](../evidence/ot-trust/pilot1-modbus-plant.journal.md). Not OT 10/10. |
