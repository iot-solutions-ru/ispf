...
| P-OT | Phase 25 OT Trust field pilots (BL-140…) | **In progress** (Pilot #1 soak days 1–2 + C5; Pilot #2 MQTT kickoff; days 3–7 open) | 7-day soak journal + OT sign-off for field Done | Lab catalog **162/162**, stubs **0** (#144). Docker fixtures **14/20**. **Pilot #1** Modbus: [day 1](../evidence/ot-trust/2026-09-06-bl140-pilot1-lab-day1.md) · [day 2](../evidence/ot-trust/2026-09-07-bl140-pilot1-day2.md) · [journal](../evidence/ot-trust/pilot1-modbus-plant.journal.md). **Pilot #2** MQTT: [kickoff](../evidence/ot-trust/2026-09-07-bl140-pilot2-mqtt-kickoff.md) (day-1 blocked on [jump SSH](../evidence/ot-trust/2026-09-07-lab-jump-ssh-blocker.md)). Not OT 10/10. |
