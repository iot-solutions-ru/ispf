...
| `sparkplug-b`, `iec61850`, `profinet`, `beckhoff-ads`, `knx`, `lorawan`, … (97 ids) | `ispf-driver-<id>` each | Protocol catalog **STUB** packs (Apache-2.0) — regenerate via `python tools/driver-stubs/generate-protocol-stubs.py` |
