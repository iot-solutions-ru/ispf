...
## Phase 0 — Stabilization (текущий фокус)
...
| # | Тема | Статус |
|---|------|--------|
| 1.1 | Acceptance PF-01: типовой app только JSON+SQL | In progress |
| 1.2 | Dogfooding warehouse + demo на одном API | Done (bundle) |
| 1.3 | PF-06 custom field labels map | Open |
| 1.4 | Bundle rollback UX в admin | Open |

## Phase 2 — Production gate

| # | Тема | Статус |
|---|------|--------|
| 2.1 | Keycloak/OIDC login в Web Console | Open |
| 2.2 | TimescaleDB hypertables + retention policies | Open |
| 2.3 | Per-object ACL (REQ новый) | Open |
| 2.4 | NATS event bus между репликами | Open |

## Phase 3 — Connectivity & HMI

| # | Тема | Статус |
|---|------|--------|
| 3.1 | Driver maturity labels (production/beta/stub) | Open |
| 3.2 | Stub-драйверы → production по demand | Open |
| 3.3 | React Router / deep links в admin | Open |
| 3.4 | Frontend smoke tests (vitest/playwright) | Open |
| 3.5 | Legacy operator manifest deprecation | Open |

## Phase 4 — Scale & topology (P3+)

| # | Тема | Статус |
|---|------|--------|
| 4.1 | PF-13 federation design + spike | Vision |
| 4.2 | Multi-tenant tree namespaces | Vision |
