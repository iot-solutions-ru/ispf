...
Платформенный слой для развёртывания прикладных решений **без Java-кода отрасли в `ispf-server`**. Соответствует [0001](decisions/0001-app-platform-boundary.md) и требованиям REQ-PF.

**Roadmap и статус REQ-PF:** [ROADMAP.md](ROADMAP.md) (Часть A).
