...
**Sprint planning:** [GAP_REGISTRY.md § Sprint planning](GAP_REGISTRY.md#sprint-planning) + §3 этого файла. Текущая волна — [ROADMAP.md § Phase 18](ROADMAP.md#phase-18--reference-solutions--v080-rollout).
