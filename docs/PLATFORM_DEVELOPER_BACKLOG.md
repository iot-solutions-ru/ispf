...
**Документация:** [AI_DEVELOPMENT.md](AI_DEVELOPMENT.md), [ADR-0011](decisions/0011-ai-artifact-generation-gates.md), [ADR-0012](decisions/0012-tree-first-ai-agent.md).
