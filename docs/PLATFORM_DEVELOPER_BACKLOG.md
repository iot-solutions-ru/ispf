...
| --------- | ---------------------------- | ---------------- | ----------------------------------------------- | --- |
| **PF-01** | Application Function Runtime | **Готово**       | Phase 5: `when`/conditionals (§8.1)             | P0  |
| **PF-02** | Application Data Layer       | **Готово**       | —                                               | P0  |
| **PF-03** | Application Package Deploy   | **Готово**       | Phase 5: objects reconcile (§8.1.5.5)           | P1  |
| **PF-04** | BPMN `invoke_function`       | **Готово**       | —                                               | P1  |
| **PF-05** | Platform Scheduler           | **Готово**       | —                                               | P1  |
| **PF-06** | BFF Wire Gateway             | **Готово**       | —                                               | P1  |
| **PF-07** | Model Registry Persistence   | **Готово**       | Phase 5: inheritance/version (§8.1.5.1)         | P2  |
| **PF-08** | Variable ↔ SQL sync          | **Готово**       | Phase 5: on_event refresh, typed values (§8.1)    | P2  |
