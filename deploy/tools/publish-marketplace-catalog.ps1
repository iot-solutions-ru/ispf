# Publish full marketplace catalog (BL-183) to IoT Solutions marketplace VPS.
...
Write-Host "Uploading marketplace catalog ($CatalogDir)..."
...
Write-Host "Patching download signing + seeding catalog on marketplace VPS..."
