...
AI_MODEL="${ISPF_AI_MODEL:-unsloth/Qwen3.6-35B-A3B-NVFP4}"
AI_API_KEY="${ISPF_AI_API_KEY:-}"
AI_TIMEOUT="${ISPF_AI_TIMEOUT_SECONDS:-180}"
...
upsert ISPF_AI_MAX_TOKENS 16384
upsert ISPF_AI_AGENT_MAX_STEPS 96
upsert ISPF_AI_AGENT_MAX_HISTORY_TURNS 50
