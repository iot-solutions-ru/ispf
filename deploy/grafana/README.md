...
| Telemetry hot path | `ispf_telemetry_coalesce_drops_total`, `ispf_telemetry_binding_bypass_total`, `ispf_telemetry_historian_only_total`, ingress pending/workers, variable-history queue |
