 ...
 * <p>
 * Supports the common {@code {"value":[...]} } entity-set shape and scalar
 * {@code {"value": ...}} property responses. Clean-room JDK-only (Apache-2.0 ISPF),
 * no third-party OData stack.
 */
public class OdataDeviceDriver implements DeviceDriver {
    ...
    public void disconnect() {
        ...
        if (driverObject != null) {
            driverObject.log(DriverLogLevel.INFO, "OData client disconnected");
        }
    }
    ...
    private DataRecord fetch(OdataPoint point) throws DriverException {
        try {
            ...
            Object parsed = OdataJson.parse(body);
