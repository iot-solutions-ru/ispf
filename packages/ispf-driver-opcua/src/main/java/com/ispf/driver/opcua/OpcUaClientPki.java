...
/**
 * Client application identity and trust list under {@code pkiDir}.
 */
public final class OpcUaClientPki implements AutoCloseable {
    ...
    private OpcUaClientPki(KeyPair keyPair, X509Certificate certificate, DefaultTrustListManager trustList) {
    ...
    public static OpcUaClientPki loadOrCreate(Path pkiDir, String commonName, String applicationUri) throws Exception {
        ...
        if (Files.isRegularFile(p12)) {
            ...
            if (!aliases.hasMoreElements()) {
                throw new IllegalStateException("Empty OPC UA client keystore: " + p12);
            }
        ...
        return new OpcUaClientPki(keyPair, certificate, new DefaultTrustListManager(pkiDir.toFile()));
    }
