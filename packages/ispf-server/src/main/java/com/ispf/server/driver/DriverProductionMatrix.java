...
final class DriverProductionMatrix {
    ...
    private static final Map<String, Entry> ENTRIES = Map.ofEntries(
            ...
            entry("iec101", DriverMaturity.PRODUCTION, POLL_WRITE,
                    ...
                    "ispf-driver-iec101"),
            entry("ansi-c12", DriverMaturity.PRODUCTION, POLL_WRITE,
            ...
            entry("lorawan", DriverMaturity.PRODUCTION, POLL_WRITE,
                    ...
                    "ispf-driver-lorawan"),
            entry("wisun", DriverMaturity.PRODUCTION, POLL_WRITE,
            ...
            entry("isa100", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-isa100", "com.ispf.driver.isa100.Isa100DeviceDriverTest"),
                    "ispf-driver-isa100"),
            entry("bluetooth-le", DriverMaturity.PRODUCTION, POLL_WRITE,
            ...
            entry("zwave", DriverMaturity.PRODUCTION, POLL_WRITE,
                    ...
                    "ispf-driver-zwave"),
            entry("thread", DriverMaturity.PRODUCTION, POLL_WRITE,
