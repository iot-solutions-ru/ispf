...
public final class OperatorAgentToolAllowlist {
    ...
    /** Tools exposed to {@link com.ispf.server.ai.agent.AgentProfile#OPERATOR} catalog and execute path. */
    ...
    public static final Set<String> MUTATING_TOOL_SAMPLES = Set.of(
            "create_object",
            "delete_object",
            "configure_driver",
            "driver_control",
