...
final class PlatformRuntimeSettingsCatalog {
    ...
    static final Map<String, String> SECTION_TITLES = Map.ofEntries(
            ...
            Map.entry("elastic", "Elastic pools"),
    ...
    private static final List<PlatformRuntimeSettingDefinition> DEFINITIONS = List.of(
            ...
            def("database", "metadata.db.kind", "ISPF_METADATA_DB_KIND", "ispf.metadata.db.kind", PlatformRuntimeSettingType.STRING, "", false, false),

            def("database", "event-journal.store", "ISPF_EVENT_JOURNAL_STORE", "ispf.event-journal.store", PlatformRuntimeSettingType.STRING, "jdbc", false, false),
            def("database", "event-journal.clickhouse.url", "ISPF_EVENT_JOURNAL_CLICKHOUSE_URL", "ispf.event-journal.clickhouse.url", PlatformRuntimeSettingType.STRING, "http://localhost:8123", false, false),
            def("database", "event-journal.clickhouse.database", "ISPF_EVENT_JOURNAL_CLICKHOUSE_DATABASE", "ispf.event-journal.clickhouse.database", PlatformRuntimeSettingType.STRING, "ispf", false, false),
            def("database", "event-journal.clickhouse.table", "ISPF_EVENT_JOURNAL_CLICKHOUSE_TABLE", "ispf.event-journal.clickhouse.table", PlatformRuntimeSettingType.STRING, "event_history", false, false),
            def("database", "event-journal.clickhouse.username", "ISPF_EVENT_JOURNAL_CLICKHOUSE_USERNAME", "ispf.event-journal.clickhouse.username", PlatformRuntimeSettingType.STRING, "default", false, false),
            def("database", "event-journal.clickhouse.password", "ISPF_EVENT_JOURNAL_CLICKHOUSE_PASSWORD", "ispf.event-journal.clickhouse.password", PlatformRuntimeSettingType.STRING, "", true, false),
            def("database", "event-journal.cassandra.contact-points", "ISPF_EVENT_JOURNAL_CASSANDRA_CONTACT_POINTS", "ispf.event-journal.cassandra.contact-points", PlatformRuntimeSettingType.STRING, "127.0.0.1", false, false),
            def("database", "event-journal.cassandra.port", "ISPF_EVENT_JOURNAL_CASSANDRA_PORT", "ispf.event-journal.cassandra.port", PlatformRuntimeSettingType.INTEGER, "9042", false, false),
            def("database", "event-journal.cassandra.local-datacenter", "ISPF_EVENT_JOURNAL_CASSANDRA_LOCAL_DATACENTER", "ispf.event-journal.cassandra.local-datacenter", PlatformRuntimeSettingType.STRING, "datacenter1", false, false),
            def("database", "event-journal.cassandra.keyspace", "ISPF_EVENT_JOURNAL_CASSANDRA_KEYSPACE", "ispf.event-journal.cassandra.keyspace", PlatformRuntimeSettingType.STRING, "ispf", false, false),
            def("database", "event-journal.cassandra.table", "ISPF_EVENT_JOURNAL_CASSANDRA_TABLE", "ispf.event-journal.cassandra.table", PlatformRuntimeSettingType.STRING, "event_history", false, false),
            def("database", "event-journal.cassandra.username", "ISPF_EVENT_JOURNAL_CASSANDRA_USERNAME", "ispf.event-journal.cassandra.username", PlatformRuntimeSettingType.STRING, "", false, false),
            def("database", "event-journal.cassandra.password", "ISPF_EVENT_JOURNAL_CASSANDRA_PASSWORD", "ispf.event-journal.cassandra.password", PlatformRuntimeSettingType.STRING, "", true, false),

            def("database", "variable-history.store", "ISPF_VARIABLE_HISTORY_STORE", "ispf.variable-history.store", PlatformRuntimeSettingType.STRING, "jdbc", false, false),
            def("database", "variable-history.clickhouse.url", "ISPF_VARIABLE_HISTORY_CLICKHOUSE_URL", "ispf.variable-history.clickhouse.url", PlatformRuntimeSettingType.STRING, "http://localhost:8123", false, false),
            def("database", "variable-history.clickhouse.database", "ISPF_VARIABLE_HISTORY_CLICKHOUSE_DATABASE", "ispf.variable-history.clickhouse.database", PlatformRuntimeSettingType.STRING, "ispf", false, false),
            def("database", "variable-history.clickhouse.table", "ISPF_VARIABLE_HISTORY_CLICKHOUSE_TABLE", "ispf.variable-history.clickhouse.table", PlatformRuntimeSettingType.STRING, "variable_samples", false, false),
            def("database", "variable-history.clickhouse.username", "ISPF_VARIABLE_HISTORY_CLICKHOUSE_USERNAME", "ispf.variable-history.clickhouse.username", PlatformRuntimeSettingType.STRING, "default", false, false),
            def("database", "variable-history.clickhouse.password", "ISPF_VARIABLE_HISTORY_CLICKHOUSE_PASSWORD", "ispf.variable-history.clickhouse.password", PlatformRuntimeSettingType.STRING, "", true, false),
            def("database", "variable-history.cassandra.contact-points", "ISPF_VARIABLE_HISTORY_CASSANDRA_CONTACT_POINTS", "ispf.variable-history.cassandra.contact-points", PlatformRuntimeSettingType.STRING, "127.0.0.1", false, false),
            def("database", "variable-history.cassandra.port", "ISPF_VARIABLE_HISTORY_CASSANDRA_PORT", "ispf.variable-history.cassandra.port", PlatformRuntimeSettingType.INTEGER, "9042", false, false),
            def("database", "variable-history.cassandra.local-datacenter", "ISPF_VARIABLE_HISTORY_CASSANDRA_LOCAL_DATACENTER", "ispf.variable-history.cassandra.local-datacenter", PlatformRuntimeSettingType.STRING, "datacenter1", false, false),
            def("database", "variable-history.cassandra.keyspace", "ISPF_VARIABLE_HISTORY_CASSANDRA_KEYSPACE", "ispf.variable-history.cassandra.keyspace", PlatformRuntimeSettingType.STRING, "ispf", false, false),
            def("database", "variable-history.cassandra.table", "ISPF_VARIABLE_HISTORY_CASSANDRA_TABLE", "ispf.variable-history.cassandra.table", PlatformRuntimeSettingType.STRING, "variable_samples", false, false),
            def("database", "variable-history.cassandra.username", "ISPF_VARIABLE_HISTORY_CASSANDRA_USERNAME", "ispf.variable-history.cassandra.username", PlatformRuntimeSettingType.STRING, "", false, false),
            def("database", "variable-history.cassandra.password", "ISPF_VARIABLE_HISTORY_CASSANDRA_PASSWORD", "ispf.variable-history.cassandra.password", PlatformRuntimeSettingType.STRING, "", true, false),

            def("elastic", "runtime-telemetry.coalesce-scheduler-elastic", "ISPF_RUNTIME_TELEMETRY_COALESCE_SCHEDULER_ELASTIC", "ispf.runtime-telemetry.coalesce-scheduler-elastic", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "runtime-telemetry.coalesce-scheduler-threads-max", "ISPF_RUNTIME_TELEMETRY_COALESCE_SCHEDULER_THREADS_MAX", "ispf.runtime-telemetry.coalesce-scheduler-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "runtime-telemetry.ingress-elastic-workers", "ISPF_RUNTIME_TELEMETRY_INGRESS_ELASTIC_WORKERS", "ispf.runtime-telemetry.ingress-elastic-workers", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "runtime-telemetry.ingress-workers-max", "ISPF_RUNTIME_TELEMETRY_INGRESS_WORKERS_MAX", "ispf.runtime-telemetry.ingress-worker-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "object-change.elastic-workers", "ISPF_OBJECT_CHANGE_ELASTIC_WORKERS", "ispf.object-change.elastic-workers-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "object-change.elastic-scale-up-threshold", "ISPF_OBJECT_CHANGE_ELASTIC_SCALE_UP_THRESHOLD", "ispf.object-change.elastic-scale-up-queue-threshold", PlatformRuntimeSettingType.INTEGER, "50", false, true),
            def("elastic", "object-change.elastic-scale-down-steps", "ISPF_OBJECT_CHANGE_ELASTIC_SCALE_DOWN_STEPS", "ispf.object-change.elastic-scale-down-steps", PlatformRuntimeSettingType.INTEGER, "6", false, true),
            def("elastic", "object-change.elastic-scale-check-ms", "ISPF_OBJECT_CHANGE_ELASTIC_SCALE_CHECK_MS", "ispf.object-change.elastic-scale-check-interval-ms", PlatformRuntimeSettingType.INTEGER, "500", false, true),
            def("elastic", "object-change.worker-threads-max", "ISPF_OBJECT_CHANGE_WORKER_THREADS_MAX", "ispf.object-change.worker-threads-max", PlatformRuntimeSettingType.INTEGER, "16", false, true),
            def("elastic", "object-change.telemetry-workers-max", "ISPF_OBJECT_CHANGE_TELEMETRY_WORKERS_MAX", "ispf.object-change.telemetry-worker-threads-max", PlatformRuntimeSettingType.INTEGER, "8", false, true),
            def("elastic", "object-change.automation-workers-max", "ISPF_OBJECT_CHANGE_AUTOMATION_WORKERS_MAX", "ispf.object-change.automation-worker-threads-max", PlatformRuntimeSettingType.INTEGER, "16", false, true),
            def("elastic", "object-change.coalesce-scheduler-elastic", "ISPF_OBJECT_CHANGE_COALESCE_SCHEDULER_ELASTIC", "ispf.object-change.coalesce-scheduler-elastic", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "object-change.coalesce-scheduler-threads-max", "ISPF_OBJECT_CHANGE_COALESCE_SCHEDULER_THREADS_MAX", "ispf.object-change.coalesce-scheduler-threads-max", PlatformRuntimeSettingType.INTEGER, "16", false, true),
            def("elastic", "object-change.scale-scheduler-elastic", "ISPF_OBJECT_CHANGE_SCALE_SCHEDULER_ELASTIC", "ispf.object-change.scale-scheduler-elastic", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "object-change.scale-scheduler-threads-max", "ISPF_OBJECT_CHANGE_SCALE_SCHEDULER_THREADS_MAX", "ispf.object-change.scale-scheduler-threads-max", PlatformRuntimeSettingType.INTEGER, "8", false, true),
            def("elastic", "variable-history.elastic-writer", "ISPF_VARIABLE_HISTORY_ELASTIC_WRITER", "ispf.variable-history.elastic-writer-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "variable-history.writer-threads-max", "ISPF_VARIABLE_HISTORY_WRITER_THREADS_MAX", "ispf.variable-history.writer-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "event-journal.elastic-writer-enabled", "ISPF_EVENT_JOURNAL_ELASTIC_WRITER", "ispf.event-journal.elastic-writer-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "event-journal.writer-threads-max", "ISPF_EVENT_JOURNAL_WRITER_THREADS_MAX", "ispf.event-journal.writer-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "event-journal.cassandra.elastic-parallel", "ISPF_EVENT_JOURNAL_CASSANDRA_ELASTIC_PARALLEL", "ispf.event-journal.cassandra.elastic-parallel-batches-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "event-journal.cassandra.parallel-batches", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_BATCHES", "ispf.event-journal.cassandra.max-parallel-partition-batches", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "event-journal.cassandra.parallel-scale-up", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_SCALE_UP", "ispf.event-journal.cassandra.elastic-parallel-scale-up-threshold", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "event-journal.cassandra.parallel-scale-down", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_SCALE_DOWN", "ispf.event-journal.cassandra.elastic-parallel-scale-down-steps", PlatformRuntimeSettingType.INTEGER, "6", false, true),
            def("elastic", "variable-history.cassandra.elastic-parallel", "ISPF_VARIABLE_HISTORY_CASSANDRA_ELASTIC_PARALLEL", "ispf.variable-history.cassandra.elastic-parallel-batches-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "variable-history.cassandra.parallel-batches", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_BATCHES", "ispf.variable-history.cassandra.max-parallel-partition-batches", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "variable-history.cassandra.parallel-scale-up", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_SCALE_UP", "ispf.variable-history.cassandra.elastic-parallel-scale-up-threshold", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "variable-history.cassandra.parallel-scale-down", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_SCALE_DOWN", "ispf.variable-history.cassandra.elastic-parallel-scale-down-steps", PlatformRuntimeSettingType.INTEGER, "6", false, true),
            def("elastic", "driver.scheduler-threads-elastic-enabled", "ISPF_DRIVER_SCHEDULER_THREADS_ELASTIC", "ispf.driver.scheduler-threads-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "driver.scheduler-threads-max", "ISPF_DRIVER_SCHEDULER_THREADS_MAX", "ispf.driver.scheduler-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, false),
            def("elastic", "driver.io-threads-elastic-enabled", "ISPF_DRIVER_IO_THREADS_ELASTIC", "ispf.driver.io-threads-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "driver.io-threads-max", "ISPF_DRIVER_IO_THREADS_MAX", "ispf.driver.io-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, false),
            def("elastic", "driver.ingress-buffer-elastic-enabled", "ISPF_DRIVER_INGRESS_BUFFER_ELASTIC", "ispf.driver.ingress-buffer-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "driver.ingress-buffer-threads-max", "ISPF_DRIVER_INGRESS_BUFFER_THREADS_MAX", "ispf.driver.ingress-buffer-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, false),
            def("elastic", "driver.mqtt-callback-elastic-enabled", "ISPF_DRIVER_MQTT_CALLBACK_ELASTIC", "ispf.driver.mqtt-callback-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("elastic", "driver.mqtt-callback-threads-max", "ISPF_DRIVER_MQTT_CALLBACK_THREADS_MAX", "ispf.driver.mqtt-callback-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("elastic", "binding.async-elastic-enabled", "ISPF_BINDING_ASYNC_ELASTIC", "ispf.binding.async-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "binding.async-threads-max", "ISPF_BINDING_ASYNC_THREADS_MAX", "ispf.binding.async-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, false),
            def("elastic", "binding-audit.elastic-writer-enabled", "ISPF_BINDING_AUDIT_ELASTIC_WRITER", "ispf.binding.audit.elastic-writer-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "binding-audit.writer-threads-max", "ISPF_BINDING_AUDIT_WRITER_THREADS_MAX", "ispf.binding.audit.writer-threads-max", PlatformRuntimeSettingType.INTEGER, "16", false, false),
            def("elastic", "function-audit.elastic-writer-enabled", "ISPF_FUNCTION_AUDIT_ELASTIC_WRITER", "ispf.function.audit.elastic-writer-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "function-audit.writer-threads-max", "ISPF_FUNCTION_AUDIT_WRITER_THREADS_MAX", "ispf.function.audit.writer-threads-max", PlatformRuntimeSettingType.INTEGER, "16", false, false),
            def("elastic", "websocket.send-elastic-enabled", "ISPF_WEBSOCKET_SEND_ELASTIC", "ispf.websocket.send-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("elastic", "websocket.send-threads-max", "ISPF_WEBSOCKET_SEND_THREADS_MAX", "ispf.websocket.send-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, false),
            def("elastic", "mqtt-gateway.ingress-dispatch-elastic-enabled", "ISPF_MQTT_GATEWAY_INGRESS_DISPATCH_ELASTIC", "ispf.mqtt-gateway.ingress-dispatch-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            ...
            def("automation", "runtime-telemetry.ingress-queue-coalesce", "ISPF_RUNTIME_TELEMETRY_INGRESS_QUEUE_COALESCE", "ispf.runtime-telemetry.ingress-queue-coalesce-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            ...
            def("automation", "event-journal.enabled", "ISPF_EVENT_JOURNAL_ENABLED", "ispf.event-journal.enabled", PlatformRuntimeSettingType.BOOLEAN, "false", false, true),
            ...
            def("automation", "event-journal.cassandra.parallel-batches-min", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_BATCHES_MIN", "ispf.event-journal.cassandra.min-parallel-partition-batches", PlatformRuntimeSettingType.INTEGER, "1", false, true),
            def("automation", "event-journal.cassandra.global-table", "ISPF_EVENT_JOURNAL_CASSANDRA_GLOBAL_TABLE_ENABLED", "ispf.event-journal.cassandra-global-table-enabled", PlatformRuntimeSettingType.BOOLEAN, "false", false, true),
            ...
            def("automation", "variable-history.cassandra.parallel-batches-min", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_BATCHES_MIN", "ispf.variable-history.cassandra.min-parallel-partition-batches", PlatformRuntimeSettingType.INTEGER, "1", false, true),

            def("automation", "binding-audit.enabled", "ISPF_BINDING_AUDIT_ENABLED", "ispf.binding.audit.enabled", PlatformRuntimeSettingType.BOOLEAN, "false", false, true),
            ...
            def("automation", "function-audit.enabled", "ISPF_FUNCTION_AUDIT_ENABLED", "ispf.function.audit.enabled", PlatformRuntimeSettingType.BOOLEAN, "false", false, true),
            ...
            def("cluster", "cluster.live-variable-sync-coalesce-ms", "ISPF_CLUSTER_LIVE_VARIABLE_SYNC_COALESCE_MS", "ispf.cluster.live-variable-sync-coalesce-ms", PlatformRuntimeSettingType.INTEGER, "500", false, false),
            def("cluster", "cluster.live-variable-sync-coalesce-enabled", "ISPF_CLUSTER_LIVE_VARIABLE_SYNC_COALESCE_ENABLED", "ispf.cluster.live-variable-sync-coalesce-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            ...
            def("drivers", "driver.mqtt-callback-threads", "ISPF_DRIVER_MQTT_CALLBACK_THREADS", "ispf.driver.mqtt-callback-threads", PlatformRuntimeSettingType.INTEGER, "4", false, true),
            def("drivers", "driver.mqtt-callback-queue-capacity", "ISPF_DRIVER_MQTT_CALLBACK_QUEUE_CAPACITY", "ispf.driver.mqtt-callback-queue-capacity", PlatformRuntimeSettingType.INTEGER, "10000", false, true),
            def("drivers", "driver.mqtt-ingress-coalesce-enabled", "ISPF_DRIVER_MQTT_INGRESS_COALESCE", "ispf.driver.mqtt-ingress-coalesce-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
