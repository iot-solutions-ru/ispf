...
final class PlatformRuntimeSettingsCatalog {
    ...
    private static final List<PlatformRuntimeSettingDefinition> DEFINITIONS = List.of(
            ...
            def("automation", "event-journal.cassandra.parallel-batches", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_BATCHES", "ispf.event-journal.cassandra.max-parallel-partition-batches", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("automation", "event-journal.cassandra.elastic-parallel", "ISPF_EVENT_JOURNAL_CASSANDRA_ELASTIC_PARALLEL", "ispf.event-journal.cassandra.elastic-parallel-batches-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("automation", "event-journal.cassandra.parallel-scale-up", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_SCALE_UP", "ispf.event-journal.cassandra.elastic-parallel-scale-up-threshold", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("automation", "event-journal.cassandra.parallel-scale-down", "ISPF_EVENT_JOURNAL_CASSANDRA_PARALLEL_SCALE_DOWN", "ispf.event-journal.cassandra.elastic-parallel-scale-down-steps", PlatformRuntimeSettingType.INTEGER, "6", false, true),
            ...
            def("automation", "variable-history.cassandra.parallel-batches", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_BATCHES", "ispf.variable-history.cassandra.max-parallel-partition-batches", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("automation", "variable-history.cassandra.elastic-parallel", "ISPF_VARIABLE_HISTORY_CASSANDRA_ELASTIC_PARALLEL", "ispf.variable-history.cassandra.elastic-parallel-batches-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("automation", "variable-history.cassandra.parallel-scale-up", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_SCALE_UP", "ispf.variable-history.cassandra.elastic-parallel-scale-up-threshold", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("automation", "variable-history.cassandra.parallel-scale-down", "ISPF_VARIABLE_HISTORY_CASSANDRA_PARALLEL_SCALE_DOWN", "ispf.variable-history.cassandra.elastic-parallel-scale-down-steps", PlatformRuntimeSettingType.INTEGER, "6", false, true),
            ...
            def("drivers", "driver.mqtt-callback-elastic-enabled", "ISPF_DRIVER_MQTT_CALLBACK_ELASTIC", "ispf.driver.mqtt-callback-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("drivers", "driver.mqtt-callback-threads-max", "ISPF_DRIVER_MQTT_CALLBACK_THREADS_MAX", "ispf.driver.mqtt-callback-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
            def("drivers", "driver.ingress-buffer-elastic-enabled", "ISPF_DRIVER_INGRESS_BUFFER_ELASTIC", "ispf.driver.ingress-buffer-elastic-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, false),
            def("drivers", "driver.ingress-buffer-threads-max", "ISPF_DRIVER_INGRESS_BUFFER_THREADS_MAX", "ispf.driver.ingress-buffer-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, false),
            def("event-journal", "event-journal.elastic-writer-enabled", "ISPF_EVENT_JOURNAL_ELASTIC_WRITER", "ispf.event-journal.elastic-writer-enabled", PlatformRuntimeSettingType.BOOLEAN, "true", false, true),
            def("event-journal", "event-journal.writer-threads-max", "ISPF_EVENT_JOURNAL_WRITER_THREADS_MAX", "ispf.event-journal.writer-threads-max", PlatformRuntimeSettingType.INTEGER, "32", false, true),
