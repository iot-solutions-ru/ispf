...
tasks.register<Zip>("assembleAnalyticsMarketplaceZip") {
    ...
    archiveFileName.set("analytics-pack-energy-1.0.0.zip")
    destinationDirectory.set(rootProject.file("examples/marketplace-analytics-energy-pack-demo"))
