...
public class ControlnetDeviceDriver implements DeviceDriver {
    ...
    private static final DataSchema VALUE_SCHEMA = DataSchema.builder("controlnetValue")
    ...
    public void writePoint(String pointId, DataRecord value) throws DriverException {
        ensureConnected();
        ControlnetPoint point = points.get(pointId);
        if (point == null) {
    ...
    private static DataRecord toRecord(ControlnetPoint point, double value) {
    ...
    private static double extractNumeric(DataRecord value) {
        if (value == null || value.rowCount() == 0) {
            throw new IllegalArgumentException("ControlNet write requires a value");
        }
        ...
        throw new IllegalArgumentException("ControlNet write requires numeric value/raw");
    }
