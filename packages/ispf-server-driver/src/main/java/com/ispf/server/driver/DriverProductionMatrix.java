...
final class DriverProductionMatrix {
    ...
    private static final Map<String, Entry> ENTRIES = Map.ofEntries(
            ...
            entry("nats", DriverMaturity.PRODUCTION, POLL_WRITE,
                    ...
                    "ispf-driver-nats"),
            entry("pulsar", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("odata", DriverMaturity.PRODUCTION, POLL_WRITE,
                    ...
                    "ispf-driver-odata"),
            entry("grpc", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("ls-xgt", DriverMaturity.PRODUCTION, POLL_WRITE,
                    ...
                    "ispf-driver-ls-xgt"),
            entry("keyence-hostlink", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-keyence-hostlink", "com.ispf.driver.keyencehostlink.KeyenceHostlinkDeviceDriverTest"),
                    "ispf-driver-keyence-hostlink"),
            entry("panasonic-mewto", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-panasonic-mewto", "com.ispf.driver.panasonicmewto.PanasonicMewtoDeviceDriverTest"),
                    "ispf-driver-panasonic-mewto"),
            entry("fatek", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-fatek", "com.ispf.driver.fatek.FatekDeviceDriverTest"),
                    "ispf-driver-fatek"),
            entry("azure-iot-hub", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-azure-iot-hub", "com.ispf.driver.azureiothub.AzureIotHubDeviceDriverTest"),
                    "ispf-driver-azure-iot-hub"),
            entry("aws-iot-core", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-aws-iot-core", "com.ispf.driver.awsiotcore.AwsIotCoreDeviceDriverTest"),
                    "ispf-driver-aws-iot-core"),
            entry("iec101", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-iec101", "com.ispf.driver.iec101.Iec101DeviceDriverTest"),
                    "ispf-driver-iec101"),
            entry("ansi-c12", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-ansi-c12", "com.ispf.driver.ansic12.AnsiC12DeviceDriverTest"),
                    "ispf-driver-ansi-c12"),
            entry("rtsp", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-rtsp", "com.ispf.driver.rtsp.RtspDeviceDriverTest"),
                    "ispf-driver-rtsp"),
            ...
            entry("dali", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-dali", "com.ispf.driver.dali.DaliDeviceDriverTest"),
                    "ispf-driver-dali"),
            entry("canbus-gateway", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("j1939", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-j1939", "com.ispf.driver.j1939.J1939DeviceDriverTest"),
                    "ispf-driver-j1939"),
            entry("codesys", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("ge-srtp", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("canopen", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("hart-ip", DriverMaturity.PRODUCTION, POLL_ONLY,
                    ...
                    "ispf-driver-hart-ip"),
            entry("bacnet-mstp", DriverMaturity.BETA, POLL_WRITE,
            ...
            entry("profibus-pa", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-profibus-pa", "com.ispf.driver.profibuspa.ProfibusPaDeviceDriverTest"),
                    "ispf-driver-profibus-pa"),
            entry("opcua-pubsub", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-opcua-pubsub", "com.ispf.driver.opcuapubsub.OpcuaPubsubDeviceDriverTest"),
                    "ispf-driver-opcua-pubsub"),
            entry("device-net", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-device-net", "com.ispf.driver.devicenet.DeviceNetDeviceDriverTest"),
                    "ispf-driver-device-net"),
            entry("controlnet", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-controlnet", "com.ispf.driver.controlnet.ControlnetDeviceDriverTest"),
                    "ispf-driver-controlnet"),
            entry("lorawan", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-lorawan", "com.ispf.driver.lorawan.LorawanDeviceDriverTest"),
                    "ispf-driver-lorawan"),
            entry("wisun", DriverMaturity.PRODUCTION, POLL_ONLY,
                    testPath("ispf-driver-wisun", "com.ispf.driver.wisun.WisunDeviceDriverTest"),
                    "ispf-driver-wisun"),
            entry("wirelesshart", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-wirelesshart", "com.ispf.driver.wirelesshart.WirelesshartDeviceDriverTest"),
                    "ispf-driver-wirelesshart"),
            entry("isa100", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-isa100", "com.ispf.driver.isa100.Isa100DeviceDriverTest"),
                    "ispf-driver-isa100"),
            entry("bluetooth-le", DriverMaturity.BETA, POLL_ONLY,
                    testPath("ispf-driver-bluetooth-le", "com.ispf.driver.bluetoothle.BluetoothLeDeviceDriverTest"),
                    "ispf-driver-bluetooth-le"),
            entry("zigbee", DriverMaturity.BETA, POLL_ONLY,
            ...
            entry("zwave", DriverMaturity.PRODUCTION, POLL_WRITE,
                    testPath("ispf-driver-zwave", "com.ispf.driver.zwave.ZwaveDeviceDriverTest"),
                    "ispf-driver-zwave"),
            entry("thread", DriverMaturity.PRODUCTION, POLL_ONLY,
                    testPath("ispf-driver-thread", "com.ispf.driver.thread.ThreadDeviceDriverTest"),
                    "ispf-driver-thread"),
            entry("cc-link", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-cc-link", "com.ispf.driver.cclink.CcLinkDeviceDriverTest"),
                    "ispf-driver-cc-link"),
            entry("cc-link-ie", DriverMaturity.BETA, POLL_WRITE,
                    testPath("ispf-driver-cc-link-ie", "com.ispf.driver.cclinkie.CcLinkIeDeviceDriverTest"),
                    "ispf-driver-cc-link-ie"),
            entry("ethernet-powerlink", DriverMaturity.BETA, POLL_WRITE,
