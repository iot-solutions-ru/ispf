...
M6_CORE141 = ";\n".join([
    ...
    # JO-PRINT-002 is ALLOWED on LM210; emc_joborder_start requires an AVAILABLE window.
    seed("emc_operations_capability",
         ["capability_id", "operations_type", "equipment_id", "segment_id", "reason", "status"],
         ["CAP-LM210-LAM", "PRODUCTION", "LM210", "SEG-LAMINATE",
          "Qualified laminator for demo start", "AVAILABLE"],
         "capability_id = 'CAP-LM210-LAM'"),
])
...
M7_UML200 = ";\n".join([
    ...
    seed("emc_ops_capability_equipment",
         ["capability_id", "equipment_id", "equipment_class_id", "quantity"],
         ["CAP-LM210-LAM", "LM210", "EQC-LAMINATOR", "1"],
         "capability_id = 'CAP-LM210-LAM' AND equipment_id = 'LM210'"),
    ...
    seed("emc_ops_capability_personnel",
         ["capability_id", "person_id", "personnel_class_id", "quantity"],
         ["CAP-LM210-LAM", "", "PCL-PRINTER", "1"],
         "capability_id = 'CAP-LM210-LAM' AND personnel_class_id = 'PCL-PRINTER'"),
    ...
    seed("emc_ops_capability_segment", ["capability_id", "segment_id"],
         ["CAP-LM210-LAM", "SEG-LAMINATE"],
         "capability_id = 'CAP-LM210-LAM' AND segment_id = 'SEG-LAMINATE'"),
    ...
    seed("emc_ops_capability_material",
         ["capability_id", "definition_id", "material_class_id", "quantity", "uom"],
         ["CAP-LM210-LAM", "WIP-PRINTED-ROLL", "MCL-WIP-ROLL", "5000", "m"],
         "capability_id = 'CAP-LM210-LAM' AND definition_id = 'WIP-PRINTED-ROLL'"),
