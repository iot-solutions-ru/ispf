...
CREATE TABLE IF NOT EXISTS gpu_sim (
  ...
  rated_kw DOUBLE NOT NULL DEFAULT 1480,
  load_pct DOUBLE NOT NULL DEFAULT 70,
  target_load_pct DOUBLE NOT NULL DEFAULT 70,
  setpoint_kw DOUBLE NOT NULL DEFAULT 1000,
  running BOOLEAN NOT NULL DEFAULT true,
  was_running BOOLEAN NOT NULL DEFAULT true,
  start_count INTEGER NOT NULL DEFAULT 0,
  running_hours DOUBLE NOT NULL DEFAULT 0,
