...
/** Row/column units for fine dashboard grid (12×7 columns, rowHeight 8). */
const FINE = 7;
function gh(rows: number): number {
  return rows * FINE;
}
function gw(cols: number): number {
  return cols * FINE;
}
  ...
  switch (type) {
    ...
    case "composite-widget":
      return {
        ...
        h: gh(3),
        childrenJson: j([
          miniValue("composite-temp", "Температура", { w: gw(4), h: gh(2) }),
    ...
    case "panel":
      return {
        ...
        collapsible: true,
        childrenJson: j([
          miniValue("panel-temp", "Температура", { w: gw(4), h: gh(2) }),
        ...
        tabsJson: j([
          {
            id: "metrics",
            label: "Метрики",
            children: [miniValue("tab-temp", "Температура", { w: gw(4), h: gh(2) })],
          },
          {
            id: "actions",
            label: "Действия",
    ...
    case "drawer-panel":
      return {
        ...
        objectPath: "",
        drawerLabel: "Детали",
        childrenJson: j([miniValue("drawer-temp", "Температура", { w: gw(4), h: gh(2) })]),
      };
    case "carousel":
      return {
        ...base,
        ...
        slidesJson: j([
          {
            id: "slide-1",
            label: "Температура",
            children: [miniValue("carousel-temp", "Температура", { w: gw(4), h: gh(2) })],
          },
          {
            id: "slide-2",
            label: "Тревога",
        ...
        stepsJson: j([
          {
            id: "step-1",
            label: "1. Обзор",
            children: [miniValue("step1-temp", "Температура", { w: gw(4), h: gh(2) })],
          },
          {
            id: "step-2",
            label: "2. Проверка",
